...
contract Voting {
    ...
    function getTotalVote() internal view returns (uint256) {
        return totalVoter;
    }

    function getTotalVoter() internal view returns (uint256) {
        return totalVote;
    }

    function getFinalResult() internal view returns (uint256) {
        return finalResult;
    }
}
